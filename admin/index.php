        ...
        <div class="main-content">
            <div class="wrapper">
                ...
                <div class="col-4 text-center">
                    ...
                    <?php 
                        //Sql Query 
                        $sql6 = "SELECT * FROM `Order` WHERE status = 'Ordered'";
                        //Execute Query
                ...
                <div class="col-4 text-center">
                    ...
                    <?php 
                        //Sql Query 
                        $sql7 = "SELECT * FROM `Order` WHERE status = 'On Delivery'";
                        //Execute Query
                ...
                <div class="col-4 text-center">
                    ...
                    <?php 
                        //Sql Query 
                        $sql7 = "SELECT * FROM `Order` WHERE status = 'Cancelled'";
                        //Execute Query
                        $res7 = mysqli_query($conn, $sql7);
                        //Count Rows
                        $count7 = mysqli_num_rows($res7);
