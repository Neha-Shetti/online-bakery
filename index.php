    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Various Bakery Items</h2>

            <?php 
                //Create SQL Query to Display CAtegories from Database
                $sql = "SELECT * FROM Products WHERE active='Yes' AND featured='Yes' ORDER BY id DESC LIMIT 3";
                //Execute the Query
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>category-foods.php?product_id=<?php echo $id; ?>">
                            <div class="box-3 float-container">
                                ...
                                <h3 class="float-text text-white" ><mark><?php echo $title; ?></mark></h3>
                            </div>
                        </a>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            //SQL Query
            $sql2 = "SELECT * FROM Flavors WHERE active='Yes' AND featured='Yes' LIMIT 6";
